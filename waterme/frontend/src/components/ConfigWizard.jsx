...
import { api } from '../api';
import { Plus, Save, Trash, Edit2, ChevronLeft, Layout, Droplets, Clock, Settings2, Sliders, Monitor, Info, Thermometer, Droplet, Activity, Timer } from 'lucide-react';
...
const ConfigWizard = () => {
    ...
    const addZone = () => {
        setEditingRoom({
            ...
            zones: [...editingRoom.zones, {
                ...
                valve_delay_ms: 100,
                stagger_minutes: 3,
                dripper_rate_ml_min: 2000, // 2.0 L/h default
                drippers_per_zone: 6,
        ...
        return (
            <div className="max-w-6xl mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        <div key={room.id} className="bg-slate-900/40 border border-slate-800 p-8 rounded-[2.5rem] group hover:bg-slate-900 transition-all duration-500 relative overflow-hidden">
                            ...
                            <div className="space-y-3 mt-6">
                                <div className="flex justify-between items-center py-2 border-b border-slate-800/50">
                                    ...
                                    <span className="text-blue-400 font-black text-xs">{room.use_fixed_schedule ? 'FIXED CLOCK' : 'SENSOR BASED'}</span>
                                </div>
                    ...
                    {rooms.length === 0 && <div className="col-span-3 text-center py-20 text-slate-700 font-bold text-xl">Create your first room to begin.</div>}
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="max-w-6xl mx-auto pb-40 px-4">
            <button onClick={() => setEditingRoom(null)} className="flex items-center gap-2 text-slate-500 hover:text-white mb-10 transition-all font-bold">
            ...
            <form onSubmit={handleSubmit} className="space-y-12">
                ...
                <div className="bg-slate-900 p-10 rounded-[3rem] border border-slate-800 shadow-2xl">
                    <h3 className="text-xs uppercase font-black text-blue-500 tracking-[0.2em] mb-6">General Room Settings</h3>
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-10">
                        <div className="md:col-span-4 flex flex-col gap-2">
                            <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Room Name</label>
                            <input
                                type="text"
                                className="w-full bg-slate-950/50 border-2 border-slate-800 rounded-2xl p-4 text-xl font-black text-white focus:outline-none focus:border-blue-600 transition-all"
                        ...
                        <div className="md:col-span-8 grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div className="bg-slate-950 p-6 rounded-[2rem] border border-slate-800/50">
                                <div className="flex items-center justify-between mb-4">
                                    <span className="text-[10px] font-black text-slate-500 uppercase">Clock Schedule</span>
                                    <input
                                        type="checkbox"
                                ...
                                {editingRoom.use_fixed_schedule ? (
                                    <div className="grid grid-cols-2 gap-4 animate-in fade-in duration-300">
                                        <div className="flex flex-col gap-1">
                                            <span className="text-[9px] font-bold text-slate-600">ON TIME</span>
                                        ...
                                        <div className="flex flex-col gap-1">
                                            <span className="text-[9px] font-bold text-slate-600">OFF TIME</span>
                ...
                <div className="space-y-8">
                    <div className="flex justify-between items-center px-4">
                        ...
                        <button type="button" onClick={addZone} className="bg-emerald-600 hover:bg-emerald-500 text-white px-8 py-3 rounded-2xl font-black transition-all">
                            ADD ZONE
                        </button>
                    </div>
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                                ...
                                <div className="lg:col-span-4 space-y-8">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <input value={zone.name} onChange={e => updateZone(idx, 'name', e.target.value)} className="bg-transparent border-b-2 border-slate-800 text-xl font-black focus:border-blue-600 focus:outline-none py-2 text-white w-full" />
                                    </div>
                                ...
                                <div className="lg:col-span-8 flex flex-col gap-10">
                                    {/* Calculations */}
                                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 bg-slate-950 p-8 rounded-[2rem] border border-slate-800">
                                        <div className="flex flex-col gap-2">
                                            ...
                                            <div className="text-[8px] text-slate-700 italic px-1 font-bold">2.0L/h ≈ 33.3ml/min</div>
                                        </div>
                                        <div className="flex flex-col gap-2">
                                            <label className="text-[9px] font-black text-slate-500 tracking-widest uppercase">Units Per Zone</label>
                                            ...
                                            <div className="text-[8px] text-slate-700 italic px-1 font-bold">Total drippers in this run</div>
                                        </div>
                                        <div className="flex flex-col gap-2">
                                            <label className="text-[9px] font-black text-slate-500 tracking-widest uppercase">Per Plant</label>
                                            ...
                                            <div className="text-[8px] text-slate-700 italic px-1 font-bold">Determines plants count</div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                                        <div className="space-y-6">
                                            <h5 className="text-[10px] font-black text-blue-500 flex items-center gap-2 tracking-widest uppercase"><Timer size={14} /> Phase 1</h5>
                                            <div className="grid grid-cols-2 gap-6">
                                                <div className="flex flex-col gap-2">
                                                    <span className="text-[9px] font-bold text-slate-600 mb-1 uppercase tracking-widest">Shots Count</span>
                                                ...
                                                <TimeInput label="Volume/Shot" value={zone.p1_volume_sec} onChange={(v) => updateZone(idx, 'p1_volume_sec', v)} />
                                            </div>
                                        </div>
                                        <div className="space-y-6">
                                            <h5 className="text-[10px] font-black text-orange-500 flex items-center gap-2 tracking-widest uppercase"><Activity size={14} /> Phase 2</h5>
                                            <div className="grid grid-cols-2 gap-6">
                                                <div className="flex flex-col gap-2">
                                                    <span className="text-[9px] font-bold text-slate-600 mb-1 uppercase tracking-widest">Shots Count</span>
                                                ...
                                                <TimeInput label="Volume/Shot" value={zone.p2_volume_sec} onChange={(v) => updateZone(idx, 'p2_volume_sec', v)} />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex gap-10 pt-4 border-t border-slate-800/50">
                                        <div className="flex flex-col gap-1">
                                            <span className="text-[9px] font-black text-slate-600 uppercase tracking-widest">Interlock Delay (ms)</span>
                                        ...
                                        <div className="flex flex-col gap-1">
                                            <span className="text-[9px] font-black text-slate-600 uppercase tracking-widest">Stagger (min)</span>
                ...
                <div className="flex justify-end gap-10 pt-10">
                    <button type="button" onClick={() => setEditingRoom(null)} className="px-10 py-5 rounded-3xl font-black text-slate-500 hover:text-white transition-all uppercase tracking-widest">Cancel</button>
                    <button type="submit" className="bg-blue-600 hover:bg-blue-500 px-16 py-6 rounded-[2.5rem] font-black transition-all shadow-2xl shadow-blue-900/40 text-lg uppercase tracking-widest">
                        SAVE CONFIG
                    </button>
                </div>
            </form>
